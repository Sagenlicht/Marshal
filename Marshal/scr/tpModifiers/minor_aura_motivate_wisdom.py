...
print "Registering Minor Aura Motivate Wisdom"
...
minorAura = PythonModifier("Minor Aura Motivate Wisdom", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnGetAbilityCheckModifier, EK_STAT_WISDOM, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_HEAL, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_LISTEN, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_PROFESSION, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_SENSE_MOTIVE, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_SPOT, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_WILDERNESS_LORE, auraBonus, ())
