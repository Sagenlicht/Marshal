...
print "Registering Minor Aura Master of Opportunity"
...
minorAura = PythonModifier("Minor Aura Master of Opportunity", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnGetAC, EK_NONE, auraBonus, ())
