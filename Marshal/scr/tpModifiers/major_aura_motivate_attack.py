...
print "Registering Major Aura Motivate Attack"
...
majorAura = PythonModifier("Major Aura Motivate Attack", 3, False) #duration, auraBonus, auraEnum
majorAura.AddHook(ET_OnToHitBonus2, EK_NONE, auraBonus, ())
