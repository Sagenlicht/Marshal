...
print "Registering Minor Aura Demand Fortitude"
...
minorAura = PythonModifier("Minor Aura Demand Fortitude", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnSaveThrowLevel, EK_SAVE_FORTITUDE, auraBonus, ())
