...
print "Registering Major Aura Resilient Troops"
...
majorAura = PythonModifier("Major Aura Resilient Troops", 3, False) #duration, auraBonus, auraEnum
majorAura.AddHook(ET_OnSaveThrowLevel, EK_NONE, auraBonus, ())
