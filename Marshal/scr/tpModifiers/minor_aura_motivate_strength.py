...
print "Registering Minor Aura Motivate Strength"
...
minorAura = PythonModifier("Minor Aura Motivate Strength", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnGetAbilityCheckModifier, EK_STAT_STRENGTH, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_CLIMB, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_JUMP, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_SWIM, auraBonus, ())
