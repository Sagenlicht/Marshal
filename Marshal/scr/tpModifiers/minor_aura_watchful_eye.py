...
minorAura = PythonModifier("Minor Aura Watchful Eye", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnSaveThrowLevel, EK_SAVE_REFLEX, auraBonus, ())
