...
print "Registering Minor Aura Accurate Strike"
...
minorAura = PythonModifier("Minor Aura Accurate Strike", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnConfirmCriticalBonus, EK_NONE, auraBonus, ())
