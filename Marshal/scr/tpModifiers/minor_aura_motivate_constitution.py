...
print "Registering Minor Aura Motivate Constitution"
...
minorAura = PythonModifier("Minor Aura Motivate Constitution", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnGetAbilityCheckModifier, EK_STAT_CONSTITUTION, auraBonus, ())
minorAura.AddHook(ET_OnGetSkillLevel, EK_SKILL_CONCENTRATION, auraBonus, ())
