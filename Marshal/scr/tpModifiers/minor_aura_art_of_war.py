...
print "Registering Minor Aura Art of War"
...
minorAura = PythonModifier("Minor Aura Art of War", 3, False) #duration, auraBonus, auraEnum
# Unsure if needs to be limited
minorAura.AddHook(ET_OnGetAbilityCheckModifier, EK_NONE, auraBonus, ())
