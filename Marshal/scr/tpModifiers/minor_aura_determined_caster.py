...
print "Registering Minor Aura Determined Caster"
...
minorAura = PythonModifier("Minor Aura Determined Caster", 3, False) #duration, auraBonus, auraEnum
minorAura.AddHook(ET_OnSpellResistanceCheckBonus, EK_NONE, auraBonus, ())
